...
from utils import get_image_counts, load_dataset_splits


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Подготовка и проверка датасета изображений транспортных средств.")
    parser.add_argument(
        "--data-dir",
        type=Path,
